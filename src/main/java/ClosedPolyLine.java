...
/**
 * Здесь упоролся в собственную же реализацию класса PolyLine. Так как ранее мы сделали возможность передавать
 * в конструктор лист точек и лист линий, а на этапе компиляции java ожидает список идентичных объектов,
 * то реализовал конструкторы через статический контекст. Думал как можно не изменяя класс PolyLine корректно
 ...
 * количество параметров (Point... listPoint) дабы была возможность нормально наследоваться без правок в классе родителя
 * <p>
